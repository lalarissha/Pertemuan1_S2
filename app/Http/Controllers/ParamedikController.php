...
class ParamedikController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect(route('paramedik'))->with('pesan', 'Data Tersimpan');
    }
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        return redirect(route('paramedik'))->with('pesan', 'Data Berhasil Diperbaharui');
    }
    ...
    public function destroy(string $id): RedirectResponse
    {
        ...
        return redirect(route('paramedik'))->with('pesan', 'Data dihapus');
    }
}
